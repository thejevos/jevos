// Agent Control Plane — information + getting-started site.
...
function home(root) {
  root.innerHTML = `<section class="hero"><div class="eyebrow"><span class="dot plane"></span>Powered by Jev</div>
      ...
      <p class="lede">Agent Control Plane sits between your AI agent and the tools it uses. Every proposed action is scored, checked against your policy, and allowed, paused for you, or stopped — before it touches the real world.</p>
...
$("#app").innerHTML = `<header class="site-nav"><a class="brand" href="#/" style="padding:0">${logo}<div class="brand-name">Agent Control Plane<span>The OS for autonomous agents · powered by Jev</span></div></a>
  ...
  <footer class="site-foot"><span>Agent Control Plane — the operating system for autonomous agents, powered by Jev.</span><span class="mono">runs locally · no account · no dashboard</span></footer>`;
